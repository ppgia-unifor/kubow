...
public class AcmeEffectorManager extends EffectorManager {
  ...
  public OperationResult publishOperation(IRainbowOperation cmd) {
    ...
    //        System.out.println ("======> AcmeEM.publishOperation[RESPOND]: " + cmd.toString () + "
    // = " + actualResult
    // .result);
